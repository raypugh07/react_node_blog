// contains all three ways to update state with react hooks,useState(incrementValue and decrementValue),
// useReducer and useContext. Having all three makes
// it easer to pick apart the differences
...
const HooksContainer1 = () => {
  ...
  const handleuseEffectValue = () => {
    setUseEffectValue("some string")  // updates the useEffectValue property of local state
  }
  ...
  }                                             // dispatches actions to change our stateprop1 in reducer1
